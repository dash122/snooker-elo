...
export function AddToHomeScreen(){
  ...
  if(!open)return null;
  return <div className="a2hs" role="dialog" aria-modal="true" aria-labelledby="a2hs-title">
    <div className="a2hs-card">
      <button className="ds-dialog-close" onClick={()=>close(false)} aria-label="關閉">×</button>
      <h2 id="a2hs-title">加到主畫面，用得更順手</h2>
