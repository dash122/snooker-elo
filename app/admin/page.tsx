...
const zh = {
  ...
  settings: "ELO 設定", settingsOpen: "開啟評分設定", playersOpen: "管理球員及個人起始 ELO", statAccounts: "帳戶總數", statAdmins: "管理員", statUnlinked: "待連結球員檔案", statAllLinked: "全部已連結",
  ...
  return <main className="auth-page admin-page">
    <section className="auth-card admin-card">
      ...
      <div className="admin-toolbar">
        <Link className="primary" href="/?tab=settings">{zh.settingsOpen}</Link>
        <Link className="more" href="/?tab=players">{zh.playersOpen}</Link>
      </div>
